...
ИТОГ 2026-08-08. КРАЙ НЕ БЫЛ ОТОБРАН ПОД ПАДЕНИЕ: все три стратегии
положительны на всех четырёх периодах, включая оба растущих.

    стратегия   2022 ↓    2023 ↑    2024 ↑    2025 ↓
    FIBO        +0.056    +0.108    +0.122    +0.134   значим везде
    LEVELS      +0.374    +0.245    +0.040    +0.279   значим на трёх из четырёх
    SMC         +0.117    +0.150    +0.018    +0.465   значим только на 2025

Опасение, ради которого замер затевался, не подтвердилось: на растущем рынке
FIBO и LEVELS работают не хуже, чем на падающем, а у FIBO рост даже лучше.

ВТОРАЯ ГИПОТЕЗА ОКАЗАЛАСЬ НЕВЕРНОЙ, И ЭТО ГЛАВНОЕ ЗДЕСЬ. Ожидалось, что перекос
«шорты сильнее лонгов» — свойство двух падающих периодов, и на росте он
перевернётся. ОН НЕ ПЕРЕВЕРНУЛСЯ. Шорты сильнее в ДЕСЯТИ клетках из двенадцати,
и обе растущие среди них:

    FIBO   2023 ↑   лонги +0.10 = шорты +0.10
    FIBO   2024 ↑   лонги +0.16 < шорты +0.19
    LEVELS 2024 ↑   лонги +0.16 > шорты -0.06   единственный явный перевес лонгов
    SMC    2023 ↑   лонги +0.18 > шорты +0.11

Перевес шортов переживает смену режима, и объяснением «рынок падал» он не
закрывается. Вопрос остаётся ОТКРЫТЫМ, а не снятым. Чем он вызван — свойством
инструментов, асимметрией ликвидаций или чем-то ещё — этот замер не отвечает; он
показывает лишь, что простое объяснение не годится.
