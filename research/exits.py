...
РЕЗУЛЬТАТ: ПРИНЯТО НОЛЬ, но картина согласованная и стоит того, чтобы её
запомнить.

ЧТО ВРЕДИТ — ЕДИНОДУШНО У ВСЕХ ТРЁХ (парная разница, бык / медведь):

    приём                        FIBO             LEVELS           SMC
    половина на 1R            −0.014/−0.012   −0.080/−0.137   −0.104/−0.029
    то же плюс безубыток      −0.032/−0.017   −0.134/−0.187   −0.315/−0.107
    трейлинг 1.5R             −0.015/−0.024   −0.113/−0.128   −0.439/−0.005

Ранняя частичная фиксация и подтяжка стопа вредят всем трём на обоих периодах,
а добавление безубытка к ранней фиксации делает ещё хуже. То же самое нашлось
на волновой стратегии: подтяжка вырезает сделки раньше, чем они доходят. Там
край был нулевой, здесь его есть что портить.

ЕДИНСТВЕННЫЙ ПРИЁМ С ПЛЮСОМ — ПРОТИВОПОЛОЖНЫЙ ПО СМЫСЛУ. «Половина на своей
цели, остаток вдвое дальше»: FIBO +0.012/+0.018, LEVELS +0.032/+0.071,
SMC +0.069/−0.010. Положителен на обоих периодах у двух стратегий из трёх,
просадка не выросла — но интервалы накрывают ноль, а у SMC на медведе знак
меняется. Приёмку не прошёл.

Смысл единый: резать рано плохо, давать дойти чуть лучше. Четыре стратегии
говорят одно.

ОДНА СТРОКА — ДИАГНОСТИКА, А НЕ РЕЗУЛЬТАТ. FIBO «трейлинг 2.5R» дал ровно
+0.000 [+0.000]. Это не «нейтрально»: цели у Фибоначчи ближе 2.5R, позиция
закрывается раньше, чем подтяжка начинает действовать. Вариант не измерился.
Читать такую клетку как «не помогло и не помешало» — ошибка.
