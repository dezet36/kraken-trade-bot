...
РЕЗУЛЬТАТ, 2026-08-06. НАБЛЮДЕНИЕ ВЕРНО, ИСПРАВЛЕНИЕ НЕ ПОМОГАЕТ.

    разрыв   бык: сумма R / R на просадку   медведь: сумма R / R на просадку
    0             128 / 19.0                      148 / 24.5
    5             116 / 15.5                      138 / 24.4
    10            124 / 16.0                      148 / 26.2
    20            134 / 17.3                      154 / 26.8
    40            100 / 14.7                      134 / 24.7

Ни один вариант приёмку не проходит. Ближе всех разрыв 20: на медвежьем
периоде он лучше по обоим показателям (154 против 148 и 26.8 против 24.5), на
бычьем даёт больше денег (134 против 128), но отдача на единицу просадки
падает — 17.3 против 19.0, потому что просадка растёт с 6.7% до 7.7%.

ЧТО ЭТО ЗНАЧИТ НА САМОМ ДЕЛЕ. Наблюдение было верным: касания действительно
кучкуются, и «касаний 3» действительно бывает там, где цена подходила один
раз. Но кучкующиеся касания НЕ ХУЖЕ разнесённых — уровень, который держат пять
пивотов в одном пятачке, отрабатывает примерно так же, как уровень с теми же
пятью касаниями за месяц.

То есть завышенный счётчик не врёт о качестве уровня, хотя врёт о его смысле.
Это не то, чего я ожидал, и ровно поэтому вопрос стоило померить, а не
чинить по описанию.

ОГОВОРКА О ЧУВСТВИТЕЛЬНОСТИ. При просадке около 6-7% отношение «сумма R к
просадке» шатко: изменение просадки на один процентный пункт двигает его на
15%. Интервалы разницы средних при 380-460 сделках шириной ±0.25 R — то есть
по краю на сделку здесь не различить ничего. Смягчать правило после того, как
увидел результат, я не стал: сегодня уже отказался делать это дважды.
