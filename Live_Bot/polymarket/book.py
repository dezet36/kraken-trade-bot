...
ДВЕ КНИГИ ОДНОГО РЫНКА — ЭТО ОДНА И ТА ЖЕ КНИГА, показанная с двух сторон.
Замерено по шести рынкам: глубина на цене A среди асков «ДА» и на цене (1-A)
среди бидов «НЕТ» совпадает ДО КОНТРАКТА.

    Newsom      0.162: 6415 контрактов   |  0.838: 6415
    Buttigieg   0.053: 15722             |  0.947: 15722
    Путин       0.080: 219701            |  0.920: 219701

Отсюда важное следствие: выбирать сторону по более короткой очереди
НЕВОЗМОЖНО — очередь у них общая. Мысль выглядит здравой и всплывает сама
собой, поэтому замер записан здесь, чтобы её не предлагали заново.
"""
