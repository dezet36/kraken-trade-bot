...
def trade_opened(signal: dict, df_1h=None):
    ...
    text = (
        ...
        f"━━━━━━━━━━━━━━━━━━━━\n"
        f"🎯 TP1:  <code>${_fmt_p(params['take_profit_1'])}</code>  (+18% от B)\n"
        f"🎯 TP2:  <code>${_fmt_p(params['take_profit_2'])}</code>  (+27%)\n"
        f"🎯 TP3:  <code>${_fmt_p(params['take_profit_3'])}</code>  (+61.8%)\n"
        f"🏆 TP4:  <code>${_fmt_p(params['take_profit_4'])}</code>  (+100% / 1:1)\n"
        f"━━━━━━━━━━━━━━━━━━━━\n"
