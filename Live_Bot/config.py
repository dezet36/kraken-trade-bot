...
# Ограничения
MAX_ACTIVE_PAIRS = int(os.getenv('MAX_ACTIVE_PAIRS', 4))   # макс. одновременных позиций
# (v2 2026-07-05: 4 по cap-сетке на 12 мес — у широкого стопа позиции живут дольше,
#  4-й слот возвращает частоту; DD при этом 11.2% — вдвое ниже v1)
