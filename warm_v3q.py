"""
warm_v3q.py — прогрев симуляций v2-геометрии (SL 88.6, TP -25, сессия, MIN_RR=0)
для всех пар ВНЕ PAIRS10 — под пул-анализ при v3 (hold336).
config_key = 'v3_hold_336' (тот же, что у 10 старых пар из geometry_grid) —
...
KNOBS = {'BLOCK_BIRTH_HOURS': SESS, 'BLOCK_FILL_HOURS': frozenset(),
         ...
         'TP1_EXT': 0.25, 'MAX_HOLD_H': 336, 'BLOCK_BIRTH_DOW': frozenset()}
...
for i, pair in enumerate(pairs):
    ...
    trd = bt12.sim_trades(pair, df1, df5, df4, CFG, 'v3_hold_336')
    del df1, df5, df4
